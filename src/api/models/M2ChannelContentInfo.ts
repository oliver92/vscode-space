...
import type { M2ChannelContentArticle } from './M2ChannelContentArticle';
...
import type { M2ChannelContentMembership } from './M2ChannelContentMembership';
...
import type { M2ChannelContentThread } from './M2ChannelContentThread';
...
export type M2ChannelContentInfo = (BillingFeedChannel | M2ChannelContentMention | M2ChannelContentCodeReviewDiscussion | M2PrivateConversationChannelContent | M2ChannelAutomationJobFeedInfo | M2ChannelContentTeam | M2ChannelIssueInfo | M2ChannelContactObsolete | M2ChannelContentThread | M2ChannelContentArticle | M2ChannelContentCodeReviewFeed | M2ChannelContentMember | SpaceNewsFeedChannel | M2ChannelContentLocation | M2ChannelContentCodeDiscussion | M2SharedChannelContent | M2ChannelContentNamedPrivateChannel | M2ChannelContentMembership | M2ChannelContentApplication);
